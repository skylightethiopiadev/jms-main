...
const Chat = () => {
  const focusHandler = (id) => {
    console.log(id, "idd");
    ["menu", "group", "private", "manager", "lawyer", "all"].map((e) => {
      const ids = document.getElementById(e);
      ids?.classList?.remove("border-b-2", "border-gray-400", "bg-gray-200");
      if (id === e) {
        ids?.classList?.add("border-b-2", "border-gray-400", "bg-gray-200");
      }
    });
  };
  ...
  return (
    <div className="flex w-full h-[100vh">
      <div className="flex border-r py-2 items-start justify-start shadow-md">
        <ul class="space-y-0 font-medium">
          ...
          >
            <a
              href="#"
              id="menu"
              class="flex flex-col items-center px-9 border-b-2 bg-gray-200 border-gray-400 py-4 text-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group"
            >
              <svg
          ...
          <li onClick={() => focusHandler("all")}>
            <a
              href="#"
              id="all"
              class="flex flex-col items-center p-2 text-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group"
            >
              <svg
                className="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
      ...
      <div className="flex flex-[62%]">
        <div class="flex-1  justify-between flex flex-col h-screen">
          ...
          <div class="border-t border-gray-200 px-4 pt-3 mb-3 sm:mb-0">
            <div class="relative flex mb-3">
              ...
              <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
                ...
                <button
                  type="button"
                  class="inline-flex items-center justify-center rounded-lg px-4 py-2 mr-2 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none"
                >
