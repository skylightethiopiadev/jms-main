    ...
    servicesList: [
      {
        ...
        text: 'Our extensive group of attorneys stands prepared to compose the following contracts:-',
        subList: [
          {
            title: 'Fixed-Price Contracts',
            text: 'These contracts define a total payment for supplies or services provided. They are used when specifications are clearly defined, and the contractor is required to deliver a product that conforms to those specifications. Fixed-price contracts place maximum responsibility on the contractor to accomplish the work stipulated in the contract.',
          },
          {
            title: 'Partnership Agreements',
            text: 'Establish agreements for business partnerships.',
          },
          {
            title: 'Joint Ventures',
            text: 'collaborative agreements between multiple parties.',
          },
          {
            title: 'Consulting Agreements',
            text: 'Specify terms for consulting services.',
          },
          {
            title: 'Provisional Agreements',
            text: 'These include nondisclosure agreements, indemnification clauses, and non-competition agreements.',
          },
          {
            title: 'Employment Contracts',
            text: 'These contracts outline the terms of employment for workers. They ensure fair compensation and protect both businesses and employees.',
          },
        ]
      },
      {
        title: 'Compliance Checks',
        text: 'Ensuring that contracts comply with local, national, and international laws.',
      },
      {
        title: 'Contract Negotiation',
        text: 'Assisting clients in negotiating terms and conditions to reach a mutually beneficial agreement.',
      },
      {
        title: 'Consultation',
        text: 'Provide counsel and representation to ensure the seamless transfer of ownership or the acquisition of unencumbered title.',
      },
      {
        title: 'Legal representation',
        text: 'In case of any disagreements related to contracts, our experienced attorneys are available to represent and support you through arbitration and legal proceedings. ',
      },
    ],
    servicesIndex: 0,
    subServicesIndex: -1,
          ...
          <div className='w-full lg:w-[50%] flex relative'>
            ...
            <div className='w-[100%] overflow-hidden relative z-0'>
              <div className='w-full h-[150px] sm:h-[210px] lg:h-full overflow-hidden'>
                <img className='w-full h-full object-center object-cover' src="https://worldref.co/wp-content/uploads/2020/10/Contract-Management-Consultants-Two-confident-business-man-shaking-hands-during-a-meeting-in-the-office-success-dealing-greeting-and-partner.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='flex flex-col md:flex-row'>
            ...
            <div className='w-[100%] md:w-[50%] relative'>
              <div className='md:absolute md:inset-0 h-[210px] md:h-auto overflow-hidden'>
                <img className='w-full h-full object-center object-cover' src="https://img.freepik.com/premium-photo/male-lawyer-discussing-negotiation-legal-case-with-client-meeting-with-document-contract-office-law-justice-attorney-lawsuit-concept_229060-322.jpg" alt="" />
              </div>
            </div>
            ...
            <div className='w-[100%] md:w-[50%] py-7 px-5 border border-gray-200 border-t-transparent md:border-t-gray-200 md:border-l-transparent bg-white transition-all ease-in-out duration-300 hover:border-gray-100 hover:shadow-md'>
              ...
              <div className='header-level-3 uppercase'>
                <p>
                  Navigate Ethiopia's Legal Landscape: Ensure Your Contracts Meet All Requirements
                </p>
              </div>
              {/* normal text */}
              <div className='my-5'>
                <p>
                  Ethiopia’s legal landscape is rich with laws that govern contractual relationships, each with its own set of formality requirements. To navigate your daily business dealings securely and avoid exploitation, it’s advisable to cement your relationships with legally enforceable contracts. Under Ethiopian law, contracts are subject to specific conditions such as the object, form, the capacity of parties, and mutual consent; without these, a contract may be considered void or rendered voidable.
                </p>
              </div>
              <div>
                <p>
                  Whether you are a merchant selling goods or services, a contractor undertaking construction projects, someone granting agency, or a consumer purchasing goods and services, it’s prudent to rely on contracts that are legally sound to shield yourself from potential disputes or to assert your rights.
                </p>
              </div>
            </div>
