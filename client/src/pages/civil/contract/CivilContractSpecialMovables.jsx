      ...
      <div className='relative'>
        ...
        <div className='absolute inset-0 flex'>
          ...
          <div className='w-full lg:w-[40%] absolute left-0 top-0 h-full z-0 lg:relative'>
            <div className='w-full h-full overflow-hidden'>
              <img className='w-full h-full object-center object-cover' src="https://www.dominionmotors.com/wp-content/uploads/2022/02/commercial-solutions.jpg" alt="" />
            </div>
          </div>
        </div>
        {/* content container */}
        <div className='relative z-30 static-padding-x pt-14 pb-32'>
          ...
          <div className='lg:w-[50%]'>
            ...
            <div className='my-3'>
              <p>
                Ethiopian property legislation delineates distinct classifications for properties, each bearing unique legal ramifications, particularly in the context of ownership acquisition and transfer.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='static-padding-x'>
          <div className='flex flex-col md:flex-row'>
            <div className='w-[85%] sm:w-[65%] mx-auto md:w-[40%] lg:w-[30%] relative '>
              <div className='relative md:absolute w-full h-full z-30 left-0 top-0 mt-[-60px] bg-neutral-800'>
