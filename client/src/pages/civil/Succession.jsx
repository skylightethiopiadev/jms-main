      ...
      <div className="mt-1 relative">
        ...
        <div className="absolute left-0 top-0 w-full h-full -z-10">
          <div className="w-full h-full overflow-hidden">
            <img className="w-full h-full object-center object-cover" src="https://www.browardschools.com/cms/lib/FL01803656/Centricity//Domain/12467/Technology%20%20Advisory%20Committee.png" alt="" />
          </div>
        </div>
        {/* background gradient */}
