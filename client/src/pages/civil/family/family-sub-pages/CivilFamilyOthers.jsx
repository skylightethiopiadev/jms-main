            ...
            <div className="relative">
                ...
                <div className="absolute left-0 top-0 w-full h-full -z-10">
                    <div className="w-full h-full overflow-hidden">
                        <img className="w-full h-full object-center object-cover" src="https://images.squarespace-cdn.com/content/v1/60a7df0518844e32d80137f4/3242a6b5-c4d2-4f11-b78d-61998fad5ec8/Family+Court+Bureua-iStock-1255741584.jpg" alt="" />
                    </div>
                </div>
                {/* content container */}
