...
const CustomersDashboardOtherServicesRightSideLinks = () => {
  return (
          ...
          <div>
            ...
            <div className='bg-white shadow-lg border border-gray-50 rounded-sm mt-1 p-1 '>
              ...
              <div className='w-full my-1'>
                <NavLink to={'/dashboard/customers/other-services/consulting'}>
                  <div className='flex items-center p-1 gap-2 rounded-sm transform-cpu ease-in-out duration-300 hover:bg-gray-100'>
                    <div className='flex items-center text-xl'>
                      <CiRollingSuitcase className='text-blue-700' />
                    </div>
                    <div>
              ...
              {/* third link */}
              <div className='w-full'>
                <NavLink to={'/dashboard/customers/other-services/research'}>
                  <div className='flex items-center p-1 gap-2 rounded-sm transform-cpu ease-in-out duration-300 hover:bg-gray-100'>
                    <div className='flex items-center text-xl'>
                      <IoDocumentTextOutline className='text-[1.15rem] text-blue-700' />
                    </div>
                    <div>
                      <span>Research</span>
                    </div>
...
export default CustomersDashboardOtherServicesRightSideLinks
