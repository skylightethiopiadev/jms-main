...
const CustomersDashboardNewTrainingForm = () => {
    ...
    <div className='overflow-x-hidden flex-grow pr-1'>
      ...
      <div className="p-[.75%] md:p-[1.5%] lg:p-[3%] border-gray-200 border rounded-md">
        <header className="flex items-center justify-between">
          <div>
            <h3 className="header-level-4">New Training Form</h3>
          </div>
        ...
        <div>
          ...
          {/* btn */}
          <div className='mt-3'>
            <button className='px-5 py-[.15rem] rounded-sm bg-gray-700 text-white transition-colors ease-in-out duration-300 hover:bg-gray-600'>Get Access</button>
          </div>
        </div>
      </div>

      {/* second order container */}
      <div className="p-[.75%] md:p-[1.5%] lg:p-[3%] border-gray-200 border rounded-md bg-gray-100 my-7">
        {/* form */}
        <div>
          {/* org detail */}
          <div>
...
export default CustomersDashboardNewTrainingForm
