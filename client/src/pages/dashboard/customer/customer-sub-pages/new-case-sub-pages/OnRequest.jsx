  ...
  return (
    <div className="w-full flex flex-col items-center justify-center ">
      ...
      {cases && cases?.data //add context here
        ? cases?.data?.map((c) => {
            return (
              <div className="flex w-full flex-col h-[100vh] overflow-y-scroll gap-5 items-center border border-gray-200">
                          ...
                          <div className="flex w-full flex-col gap-2">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-4 items-start flex-col lg:flex-row gap-5 justify-between w-full my-2">
                              <div className="flex flex-col items-start">
                                ...
                                <p className="">
                                  {formatSalary(c.paymentDetail.total / 1)} birr
                              ...
                              <div className="flex flex-col items-start">
                                ...
                                <p className="">
                                  {formatSalary(c.paymentDetail.remaining / 1)}{" "}
                                  birr
                                  <span className="text-xs font-bold text-main ml-1">
                                    {(
                              ...
                              <div className="flex flex-col items-start">
                                ...
                                <p className="">
                                  {formatSalary(c.paymentDetail.payed / 1)} birr{" "}
                                  <span className="text-xs font-bold text-main ml-1">
                                    {(
