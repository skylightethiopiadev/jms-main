...
const LawyersProfile = () => {
  ...
  const updateHandler = () => {
    ...
    formData.append("url", `/user/lawyers?id=${users?.data[0]?.user?._id}`);
    formData.append("tag", ["lawyers"]);
    updateData(formData);
  };
  ...
  return (
    <div className="w-full h-auto pb-10 -mt-6  px-5 flex flex-col gap-3">
      ...
      <div className="px-[.75%] md:px-[1.5%] bg-gray-100 lg:px-[3%] py-1 md:py-3 border-gray-200 border rounded-md">
        <div>
          <p>
            Dear Lawyers, Please take a moment to fill out the following fields
            based on your personal information. Providing us with this details
            will help us better understand your needs and enable us to deliver
            the highest quality service tailored to your specific requirements.
            We are committed to going above and beyond to ensure your
