            ...
            >
              <div className="mt-4 w-full h-auto bg-white relative border rounded-md border-gray-200 ppt-12">
                ...
                <div className="flex items-center gap-3 px-1">
                  <a
                    href="/dashboard/lawyers/profile"
                  ...
                  <a
                    href="/dashboard/lawyers/change-password"
                    className="flex items-center gap-1 transition-colors ease-in-out duration-300 hover:text-red-600"
                  >
                ...
                <button
                  ...
                  className="flex items-center gap-1 mt-2 self-start ml-2 mb-2 px-2 py-[.15rem] rounded-sm bg-gray-700 text-white"
                >
