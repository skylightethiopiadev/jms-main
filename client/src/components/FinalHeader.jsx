...
const FinalHeader = () => {
  ...
  const [languages, setLanguages] = useState([
    ...
    {
      language: 'Eng(UK)',
      flag: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvwtwkduPTWWCLfVE37c1vlKoN7GrpUKukM98EgKNprg&s',
    },
    {
      language: 'Swahili',
                        ...
                        return (
                          <li key={index}>
                            <div className="w-full cursor-pointer py-1 px-3 flex items-center gap-2 my-1 bg-transparent transition-colors ease-in-out duration-300 hover:bg-gray-100">
                              ...
                              <div className="flex items-center"><span className="text-xs text-gray-700">{item.language}</span></div>
                            </div>
                          </li>
                        )
                      })
