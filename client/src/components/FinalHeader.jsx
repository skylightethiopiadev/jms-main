        ...
        },
        {
          ...
          subNavList: [
            ...
            },
            {
              ...
              path:
                "/corporate/intellectual-property/varieties-plant-breeds-right"
            }
          ]
        },
        {
        ...
        <div className="flex-grow flex items-center justify-between relative">
                        ...
                        <div className="w-full h-full flex">
                          <div className="flex-grow py-[3%] lg:px-[20%] h-full w-[350px] my-1 lg:my-auto overflow-y-auto flex flex-col lg:flex-row gap-y-0 lg:justify-between">
                            ...
                            <div className="flex flex-col h-[350px] lg:h-auto">
                              <div>
                                <NavLink
                                  to={civilSubNav[0].groupOne[0].path}
                            ...
                            <div className="flex flex-col h-[200px] lg:h-auto">
                              <div>
                                <NavLink
                                  className="font-semibold mb-3 text-[1.35rem] hover:underline"
                                  to={civilSubNav[0].groupOne[1].path}
                                  onClick={() => {
                                    setIsNav(null);
                                    scrollIntoHomeTopHandler();
                                  }}
                        ...
                        <div className="w-full h-full flex ">
                          <div className="flex-grow py-[3%] px-[2%] flex flex-col lg:flex-row h-full overflow-y-auto lg:overflow-hidden pb-[100px] my-1 lg:my-auto lg:pb-0 justify-between gap-5">
                            ...
                            <div className="flex flex-col">
                              <div>
                                <NavLink
                                  className="font-semibold text-[1.35rem] mb-3 hover:underline"
                                  to={commercialSubNav[0].groupOne[0].path}
                                  onClick={() => {
                                    setIsNav(null);
                                    scrollIntoHomeTopHandler();
                                  }}
                            ...
                            <div className="flex flex-col">
                              <div>
                                <NavLink
                                  className="font-semibold text-[1.35rem] mb-3 hover:underline"
                                  to={commercialSubNav[0].groupOne[1].path}
                                  onClick={() => {
                                    setIsNav(null);
                                    scrollIntoHomeTopHandler();
                                  }}
                            ...
                            <div>
                              <div>
                                <NavLink
                                  to={commercialSubNav[0].groupOne[3].path}
                                  className="font-semibold mb-3 text-[1.35rem] hover:underline"
                                  onClick={() => {
                                    setIsNav(null);
                                    scrollIntoHomeTopHandler();
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            {context?.user ? (
              <div className="relative">
                ...
                >
                  ...
                  <div>
                    <IoIosArrowDown
                      className={`text-xs transition-all ease-in-out duration-300 ${
            ...
            <div className="relative">
                ...
                <div>
                  <MdKeyboardArrowDown
                    className={`transition-transform ease-in-out duration-300 ${
                      languageOption ? "rotate-[-180deg]" : "rotate-0"
                    }`}
                  />
                </div>
              </div>
              {/* language list */}
              <div
                className={`absolute right-0 top-[50px] bg-transparent z-50 transition-all ease-in-out duration-300 overflow-hidden ${
                  languageOption ? "h-[64vh]" : "h-0"
                }`}
              >
